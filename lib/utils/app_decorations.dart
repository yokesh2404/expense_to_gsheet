...
class BoxDecorations {
  ...
  static BoxDecoration buildBoxDecoration_1({
    ...
    Color? borderColor,
    Color decColor = Colors.white,
    double? decOpacity,
  }) {
    return BoxDecoration(
      border: Border.all(width: borderWidth, color: borderColor ?? decColor),
  ...
  static BoxDecoration buildBoxDecorationImage({
    double radius = 0,
    required String decImage,
  }) {
    return BoxDecoration(
      borderRadius: BorderRadius.circular(radius),
      image: DecorationImage(image: AssetImage(decImage), fit: BoxFit.fill),
    );
  }
  ...
  //       color: Colors.whiteColor().withOpacity(0.8),
  //       boxShadow: [
  //         BoxShadow(
